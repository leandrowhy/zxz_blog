...
<template>
  <div class="share">
    <el-tooltip class="item" effect="dark" content="评论" placement="right">
      <a href="#commentsSection" class="icon-cricle iconfont icon-pinglun1"></a>
    </el-tooltip>
    ...
    <p class="title">分享</p>
    <div>
      <el-tooltip class="item" effect="dark" content="分享到QQ空间" placement="right">
        <span @click="shareClick(1)" class="icon-cricle iconfont icon-iconfonttencentweibo"></span>
      </el-tooltip>
      <el-tooltip class="item" effect="dark" content="分享到新浪微博" placement="right">
        <span @click="shareClick(2)" class="icon-cricle iconfont icon-weibo"></span>
      </el-tooltip>
      <el-tooltip class="item" effect="dark" content="分享到QQ" placement="right">
        <span @click="shareClick(3)" class="icon-cricle iconfont icon-qq"></span>
      </el-tooltip>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    goMNode() {
      window.location.href = '#commentsSection'
    }
  }
}
</script>
