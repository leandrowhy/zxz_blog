      ...
      <div class="player">
        <div class="player__top">
          <div class="player-cover">
            <transition-group :name="transitionName">
              <div
                ...
                :style="{
                  backgroundImage: `url(${
                    tracks.length > 0 ? tracks[currentTrackIndex].cover : ''
                  })`
                }"
              ></div>
            </transition-group>
          ...
          <div class="player-controls">
            ...
            <div :href="currentTrack.url" target="_blank" class="player-controls__item">
              <svg class="icon">
...
<script>
import { getMusicPlayUrl } from '@/api/music.js'
export default {
  name: 'index',
  props: {
    listArr: {
  ...
  methods: {
    ...
    async prevTrack() {
      ...
      await this.getPlayerUrl(this.tracks[this.currentTrackIndex].source)
    ...
    async getPlayerUrl(strUrl) {
      if (!strUrl) {
        const resSong = await getMusicPlayUrl(this.tracks[this.currentTrackIndex].id)
        this.tracks[this.currentTrackIndex].source = resSong.data[0].url
      }
    },
    resetPlayer() {
      this.barWidth = 0
