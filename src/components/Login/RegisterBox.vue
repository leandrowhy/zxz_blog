<template>
  <div class="register">
    <div class="centen-box">
      ...
      <span class="btn next-btn" @click="nextClick" v-show="active == 1"
        >下一步</span
      >
      <div class="btn-box">
        <span class="btn next-btn" @click="backClick" v-show="active == 2"
          >上一步</span
        >
        <span class="btn reg-btn" @click="regClick" v-show="active == 2"
          >注册</span
        >
      </div>
    </div>
